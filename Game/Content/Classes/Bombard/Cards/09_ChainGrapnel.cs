...
public class ChainGrapnel : BombardCardModel<ChainGrapnel.CardTop, ChainGrapnel.CardBottom>
{
	...
	public class CardTop : BombardCardSide
	{
		...
		[
			...
			new AbilityCardAbility(new AttackAbility(2, range: 3, push: 2,
				conditions:
				[
					Conditions.Immobilize
				])) //TODO: Card art is wrong, it's supposed to be a pull. Leaving it like this for now or it will cause confusion.
		];

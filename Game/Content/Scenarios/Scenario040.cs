...
public class Scenario040 : ScenarioModel
{
	...
	protected override ScenarioGoals CreateScenarioGoals() =>
		new KillSpecificEnemyTypeGoals(ModelDB.Monster<DrakePorter>(), "Kill the Drake Porter to win this scenario.");
	...
	public override async GDTask StartAfterFirstRoomRevealed()
	{
		...
		//TODO: add once cs1 items added to develop
	...
	protected override async GDTask OnRoomRevealed(ScenarioEvents.RoomRevealed.Parameters parameters)
	{
		...
		ScenarioEvents.FigureKilledEvent.Subscribe(this, _door1,
			...
			apply: async parameters =>
			{
				...
				{
					await AbilityCmd.SufferDamage((AttackAbility.State)parameters.PotentialAbilityState, drakePorter, 2);
					//TODO: Remove cast
				}

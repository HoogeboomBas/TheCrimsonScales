...
public class MonsterForcedMovementPrompt(
	...
	EffectCollection effectCollection, Func<string> getHintText, bool? direction = null)
	: Prompt<MonsterForcedMovementPrompt.Answer>(effectCollection, getHintText)
{
	...
	protected override void Enable()
	{
		...
		MoveHelper.FindReachableForcedMovementHexes(abilityState, _currentNode, target, origin, type, _closedList, direction: direction);
